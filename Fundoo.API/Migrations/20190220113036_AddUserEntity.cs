//-----------------------------------------------------------------------
// <copyright file="AddUserEntity.cs" company="BridgeLabz">
//     Company copyright tag.
// </copyright>
//-----------------------------------------------------------------------
namespace Fundoo.API.Migrations
{
    using Microsoft.EntityFrameworkCore.Migrations;

    /// <summary>
    /// add user identity is class which extending migration class of entity framework
    /// </summary>
